...
export const Login = () => {
    ...
    return (
        <div className='min-h-screen w-full flex items-center justify-center bg-teal-200'>
            <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-4 p-4 rounded-lg shadow-xl border bg-gray-50 w-2/6'>
                ...
                <button type='submit' className='bg-black bg-opacity-50 rounded-lg p-2 font-bold text-white hover:bg-blue-400'>Login</button>
            </form>
        </div>
    );
};
